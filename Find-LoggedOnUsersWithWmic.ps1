...
.EXAMPLE
  ...
  somejumpbox   explorer.exe 4408 5728 e-Cyan.Foss                True C:\Windows\Explorer.EXE
  somejumpbox   explorer.exe 352  4156 e-Jannus.Fugal             True C:\Windows\Explorer.EXE
  RemJumpbox01                                                   False
...
.NOTES
  ...
  Author:  Travis Logue
  Version History:  1.1 | 2021-03-17 | Initial Version
  Dependencies:
  Notes:
